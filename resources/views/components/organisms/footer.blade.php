    ...
    <div class="container relative z-10 px-4 py-12 mx-auto">
        <div class="grid grid-cols-1 gap-8 md:grid-cols-4">
            ...
            <div class="col-span-1 md:col-span-1" @mouseenter="hoveredColumn = 'brand'" @mouseleave="hoveredColumn = null">
                <x-atoms.logo />
                <p class="mt-4 mb-4 text-sm text-purple-300">The ultimate companion for Shadowverse players. Card
                    ratings,
            ...
            <div class="col-span-1" @mouseenter="hoveredColumn = 'links'" @mouseleave="hoveredColumn = null">
                ...
                <ul class="space-y-2 text-sm">
                    <li>
                        <a href="#"
                            class="relative pl-3 text-purple-300 transition-colors duration-200 hover:text-white"
