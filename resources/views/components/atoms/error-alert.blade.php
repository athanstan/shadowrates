...
<div x-data="{
    ...
    x-transition:leave-end="opacity-0 transform scale-90" @class([
        'fixed z-50 flex items-center p-4 rounded-lg shadow-lg bg-gray-900 border border-red-500',
    ...
    <div class="flex items-center">
        <div class="flex-shrink-0 p-1 rounded-full bg-gradient-to-b from-red-500 to-red-700 mr-3">
        ...
        <div>
            <p class="font-medium text-white" x-text="message">Error message here</p>
        </div>
    </div>
